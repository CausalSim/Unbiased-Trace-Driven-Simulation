...
for left_out_policy in buffer_based_names:
    ...
    for idx, key in enumerate(keys):
        for C in C_list:
            with open(f'{args.dir}subset_EMDs/seed_{args.seed}/{left_out_policy}/sim_{key}_{C}.pkl', 'rb') as f:
                sim_dict = pickle.load(f)
            with open(f'{args.dir}subset_EMDs/seed_{args.seed}/{left_out_policy}/expert_{key}_{C}.pkl', 'rb') as f:
                expert_dict = pickle.load(f)
            with open(f'{args.dir}subset_EMDs/seed_{args.seed}/{left_out_policy}/sl_{key}_{C}.pkl', 'rb') as f:
    ...
    with open(f'{args.dir}subset_sl_ssim_dicts/seed_{args.seed}/{left_out_policy}/ssims.pkl', 'rb') as f:
    ...
    for C in C_list:
        with open(f'{args.dir}subset_ssim_dicts/seed_{args.seed}/{left_out_policy}/ssims_{C}.pkl', 'rb') as f:
